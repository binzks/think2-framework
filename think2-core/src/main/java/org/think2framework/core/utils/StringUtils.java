...
public class StringUtils {
		...
		try {
			...
			if (InitStripAccents.java6NormalizeMethod != null) {
				...
				throw new UnsupportedOperationException(
						"The stripAccents(CharSequence) method requires at least" + " Java6, but got: "
								+ InitStripAccents.java6Exception + "; or a Sun JVM: " + InitStripAccents.sunException);
			}
	 ...
	 *         ({@code INDEX_NOT_FOUND}) if no match or {@code null} string
	 *         input
	 * @since 2.1
	 ...
	 *
	 * <p>
	 * For a word based algorithm A {@code null} input String returns
	 * {@code null}.
	 * </p>
	 *
	 * <pre>
	 ...
	 * Levenshtein distance algorithm from <a href=
	 * "http://www.merriampark.com/ld.htm">http://www.merriampark.com/ld.htm</a>
	 * </p>
	 *
	 * <pre>
	...
	public static boolean startsWithAny(CharSequence string, CharSequence... searchStrings) {
		if (isEmpty(string) || (null == searchStrings || searchStrings.length == 0)) {
			return false;
		}
