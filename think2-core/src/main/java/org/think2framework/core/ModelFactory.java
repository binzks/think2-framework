...
public class ModelFactory {
	...
	public static Query createQuery(String name) {
		...
		return datasource.createQuery(model.getTable(), model.getPk(), null, redis, model.getFilters(),
	...
	public static Writer createWriter(String name) {
		Model model = get(name);
		Datasource datasource = DatasourceFactory.get(model.getQuery());
		return datasource.createWriter(model.getTable(), model.getPk(), model.getAutoIncrement(), null,
